    ...
    <div className ="App">
      ...
      (<form onSubmit ={validation}>
       <p>Username </p>  <input id='uname' type = "text" onChange ={usernameChange} placeholder="Enter Username" required />
        ...
        <p>Email</p> <input id ='emailname' type = "text" onChange ={emailChange} placeholder="Enter your email"required/>
        {!formitem.emailvalidation && <p style={{color:'red',fontFamily:'serif'}}> Email is wrong</p>}
        <p>Password</p> <input  id ='pwd'type = "password" onChange ={passwordChange} placeholder="Enter your password"required />
